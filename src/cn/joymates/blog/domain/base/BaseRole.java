...
public class BaseRole extends BaseVO {
	public BaseRole() {
        ...
        fieldMap.put("roleQutoa", "role_qutoa");
	...
	public Integer getRoleQutoa() {
		return roleQutoa;
	}
	public void setRoleQutoa(Integer roleQutoa) {
		this.roleQutoa = roleQutoa;
	}
