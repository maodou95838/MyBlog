...
<body class="ContentBody">
	<form action="${pageContext.request.contextPath}/admin/org/org_modify.html"
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<TR>
												...
												<td width="27%"><input name="org.name" id="Input22"
													class="text required" style="width:154px" maxlength="20" value="${org.name}"/>
													<input type="hidden" name="org.uuid" value="${org.uuid}"/>	
												</td>
											</tr>
											<tr>
												<td nowrap align="right">机构描述:</td>
												<td><input name="org.desc1" id="Input" class="text"
													style="width:154px" maxlength="60" value="${org.desc1}"/></td>
											</tr>
											<tr>
